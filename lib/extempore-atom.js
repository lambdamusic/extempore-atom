...
function evaluate() {
  ...
  if(selectedText) {
    ...
    //decoration = editor.decorateMarker(marker, {type: 'line', class: "highlight-line"})
    decoration = editor.decorateMarker(marker, {type: 'highlight', class: "highlight-region"})
  ...
  //var lines = editor.getBuffer().getTextInRange(range);
  send_string(lines);
}
